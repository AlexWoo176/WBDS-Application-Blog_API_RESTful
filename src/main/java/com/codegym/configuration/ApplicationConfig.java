...
import com.codegym.services.impl.BlogServiceImpl;
import com.codegym.services.impl.CategoryServiceImpl;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public void addFormatters(FormatterRegistry registry) {
        registry.addFormatter(new CategoryFormatter(this.applicationContext.getBean(CategoryService.class)));
    }
